...
namespace QLKHO_PhanVanHoang.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(IUnitOfWork unitOfWork, INotificationService notificationService)
        {
        ...
        public async Task<IActionResult> UpdatePermissions(int id, [FromBody] UpdateRolePermissionsDto dto)
        {
            ...
            await _notificationService.SendPermissionsUpdatedToRoleAsync(role.Name);
